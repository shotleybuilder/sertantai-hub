defmodule SertantaiHub.Auth.JwksClient do
  @moduledoc """
  ...
  @impl true
  def init(_opts) do
    if Application.get_env(:sertantai_hub, :test_mode, false) do
  ...
  defp fetch_jwks do
    auth_url = Application.get_env(:sertantai_hub, :auth_url)
  ...
  defp req_plug do
    Application.get_env(:sertantai_hub, :jwks_req_plug)
  end
end
