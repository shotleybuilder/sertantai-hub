#!/bin/bash
#
# push-backend.sh - Push SertantAI Hub Backend Docker image to GitHub Container Registry
#
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}  SertantAI Hub Backend - Push to GHCR${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo -e "  ${GREEN}→${NC} Push frontend: ${YELLOW}./scripts/deployment/push-frontend.sh${NC}"
