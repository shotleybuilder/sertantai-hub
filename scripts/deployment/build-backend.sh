#!/bin/bash
#
# build-backend.sh - Build production Docker image for SertantAI Hub Backend
#
...
#   - Push to GHCR: ./scripts/deployment/push-backend.sh
#
...
show_help() {
    ...
    echo ""
    echo "Build production Docker image for SertantAI Hub Backend."
    echo ""
    echo "Arguments:"
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}  SertantAI Hub Backend - Docker Build${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo -e "  ${GREEN}→${NC} Push to GHCR:  ${YELLOW}./scripts/deployment/push-backend.sh${NC}"
    echo ""
else
    echo ""
    echo -e "${RED}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
